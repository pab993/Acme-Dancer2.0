...
<%-- 		<jstl:choose>
	...
	<display:column property="displayMoment" title="${createMomentHeader}"
	...
	<spring:message code="trackson.course" var="courseHeader" />
	<display:column property="course.title" title="${courseHeader}" class="${boldItalic}"/>
